  ...
  <div class="max-w-screen-xl flex items-center justify-between mx-auto p-4 relative">
    ...
    <div class="flex items-center space-x-4">
      ...
      <div class="relative">
        ...
        <div
          class="absolute right-0 top-full mt-2 z-50 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow-lg dark:bg-gray-700 dark:divide-gray-600"
          id="user-dropdown"
          role="menu"
