                ...
                <table class="w-full text-xs text-left text-gray-500 border border-gray-300">
                    <thead class="text-[10px] text-white uppercase bg-blue-900">
                        <tr>
                            ...
                            <th class="px-4 py-2 border border-gray-300">Dospem 1</th>
                            <th class="px-4 py-2 border border-gray-300">Dospem 2</th>
                            <th class="px-4 py-2 border border-gray-300">Penguji</th>
                            <th class="px-4 py-2 border border-gray-300">Tanggal Sempro</th>
                            <th class="px-4 py-2 border border-gray-300">Tanggal Semhas</th>
                    ...
                    <tbody>
                        <tr class='bg-white even:bg-gray-50 border-b hover:bg-blue-50'>
                            ...
                            <td class='px-4 py-2 border border-gray-300'>Dr. Budi Santoso<br><span class='text-gray-500'>123456789</span></td>
                            <td class='px-4 py-2 border border-gray-300'>Dr. Siti Aminah<br><span class='text-gray-500'>987654321</span></td>
                            ...
                            <td class='px-4 py-2 border border-gray-300'>10-05-2024 | 08:00</td>
                            <td class='px-4 py-2 border border-gray-300'>15-06-2024 | 10:00</td>
                            <td class='px-4 py-2 border border-gray-300'>20-07-2024 | 13:00</td>
                        </tr>
                        <tr class='bg-white even:bg-gray-50 border-b hover:bg-blue-50'>
                            ...
                            <td class='px-4 py-2 border border-gray-300'>Dr. Andi Wijaya<br><span class='text-gray-500'>123123123</span></td>
                            <td class='px-4 py-2 border border-gray-300'>Dr. Rina Sari<br><span class='text-gray-500'>321321321</span></td>
                            <td class='px-4 py-2 border border-gray-300'>
                                <table class="penguji-table">
                            ...
                            <td class='px-4 py-2 border border-gray-300'>12-05-2024 | 09:00</td>
                            <td class='px-4 py-2 border border-gray-300'>17-06-2024 | 11:00</td>
                            <td class='px-4 py-2 border border-gray-300'>22-07-2024 | 14:00</td>
                        </tr>
                    </tbody>
                </table>
            </div>
